    ...
    employee_data = {
        "employees": [
            ...
            },
            {
                ...
                "firstname": "David",
                "lastname": "Wilson",
                "email": "david@techmicro.com",
                "phone": "555-0998",
                "departmentId": 3,
                "departmentName": "Sales",
                "companyName": "TechMicro",
            },
            {
                "id": 5,
                "firstname": "Mary",
                "lastname": "Johnson",
                "email": "mary@techmicro.com",
                "phone": "555-1165",
                "departmentId": 4,
                "departmentName": "HR",
                "companyName": "TechMicro",
...
def populate_files():
    ...
    insert_file(
        "Fields.jpg",
        "A road in the fields of flowers leading to the mountains.",
        "static/images/Fields.jpg",
    )
    insert_file(
        "Waterfall.jpg",
        "A Cascading Waterfall under pink trees.",
        "static/images/Waterfall.jpg",
    )
